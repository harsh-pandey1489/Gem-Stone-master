            ...
            <div className="relative z-10 max-w-[1400px] mx-auto flex flex-col items-center">
                ...
                <div className="relative w-full max-w-[1200px] flex flex-col-reverse sm:flex-row sm:h-[450px] lg:h-[550px] items-center justify-center gap-10 sm:gap-0">
                    ...
                    <div className="sm:hidden flex flex-col gap-6 w-full px-6 z-30">
                         <div className="bg-white/90 backdrop-blur-sm p-6 rounded-[24px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] border border-gray-100 text-center">
                    ...
                    <div className="relative w-full max-w-[280px] sm:max-w-[350px] lg:max-w-[500px] z-10 transition-all duration-300">
                        <img
                            src="https://res.cloudinary.com/daup99ghe/image/upload/v1776926157/Your_Digital_Birth_Chart_nrq8nn.png"
                            alt="Digital Birth Chart"
                    ...
                    <div className="hidden sm:block absolute left-[-10px] lg:left-0 top-[65%] sm:top-[70%] -translate-y-1/2 z-30 group">
                    ...
                    <div className="hidden sm:block absolute right-[-10px] lg:right-0 top-[30%] sm:top-[25%] -translate-y-1/2 z-30 group">
                        <div className="bg-white/80 backdrop-blur-md border border-white p-4 lg:p-6 rounded-[24px] shadow-[0_8px_30px_rgba(0,0,0,0.04)] w-[180px] lg:w-[240px] transition-all duration-300 group-hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
