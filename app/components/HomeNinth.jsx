...
export default function HomeNinth() {
  return (
    <section className="max-w-[1720px] mx-auto flex justify-center px-4 py-10 bg-white">
      <div className=" bg-[#5A3E43] md:px-60 md:py-24  text-white rounded-3xl px-6 md:px-12 py-10 md:py-14 text-center shadow-lg">
        ...
        {/* Button */}
        <button className="bg-[#E57661] hover:bg-[#d86551] text-[15px] md:text-[18px] text-white px-6 md:px-10 py-6 rounded-lg font-medium transition-all duration-300 hover:bg-white hover:text-[#d86551] cursor-pointer  active:scale-95">
