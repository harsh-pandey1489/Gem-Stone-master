            ...
            <div className="max-w-7xl mx-auto px-5 min-[500px]:px-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="grid grid-cols-1 min-[400px]:grid-cols-3 gap-4 min-[500px]:gap-6 mt-4">
                        <div className="border border-[#E57661] rounded-[10px] py-4 flex flex-col items-center justify-center bg-white">
                            <img
                                ...
                                alt="Confidence"
                            />
                            <span className="text-[#303030] text-[18px] font-[500]">Confidence</span>
                        </div>
                        ...
                        <div className="border border-[#E57661] rounded-[10px] py-4 flex flex-col items-center justify-center bg-white">
                            <img
                                ...
                                alt="Success"
                            />
                            <span className="text-[#303030] text-[18px] font-[500]">Success</span>
                        </div>
                        ...
                        <div className="border border-[#E57661] rounded-[10px] py-4 flex flex-col items-center justify-center bg-white">
                            <img
                                ...
                                alt="Leadership"
                            />
                            <span className="text-[#303030] text-[18px] font-[500]">Leadership</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-row justify-between gap-4 flex-wrap">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-[#303030]">
                                {product.rating || "4.8"} <span className="text-gray-400">({product.reviews || "0"})</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <p className="text-[12px] text-[#303030] font-[500]">
                        <span className="font-bold">Note:</span> Free shipping is only available when full cart value exceeds $99.99.
                    </p>

                    <div className="flex flex-col gap-4 mt-6">
                        <div className="flex flex-col gap-3">
                            <p className="text-[16px] text-[#303030] font-[400] uppercase tracking-wide">SHARE ON SOCIAL MEDIA:</p>
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-3">
                                <img src="https://res.cloudinary.com/daup99ghe/image/upload/v1776845013/Vector_5_rrbuyb.png" alt="truck" className="w-5 h-5 object-contain" />
                                <span className="text-[15px] text-[#303030] font-[500]">Get FREE Shipping on orders above $99</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <img src="https://res.cloudinary.com/daup99ghe/image/upload/v1776845077/Group_1171275256_1_pnkjrt.png" alt="return" className="w-5 h-5 object-contain" />
                                <span className="text-[15px] text-[#303030] font-[500]">Easy Return Process</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="border border-[#E5E5E5] rounded-[14px] px-4 min-[500px]:px-5 py-5 bg-[#FCFCFC] flex flex-col min-[500px]:flex-row items-start min-[500px]:items-center gap-4 min-[500px]:gap-0 justify-between">
                            <div className="flex flex-col">
                                <div className="flex flex-row items-center gap-2">
                                    <img src="https://res.cloudinary.com/daup99ghe/image/upload/v1776845076/Customer_Service_1_kuhcib.png" alt="customer-service" className="w-8 h-8 object-contain flex-shrink-0" />
                                    <h3 className="text-[24px] leading-none font-[500] text-[#E57661]">Need any Guidance?</h3>
                                </div>
                                <p className="mt-2 text-[15px] text-[#303030] opacity-80">Connect with an expert for your assistance.</p>
                            </div>
                            <button className="h-[48px] w-full cursor-pointer min-[500px]:w-auto px-6 py-2 border border-[#E57661] text-[#E57661] text-[13px] font-[500] uppercase tracking-widest hover:bg-[#E57661] hover:text-white transition whitespace-nowrap rounded-sm">CONTACT US</button>
                        </div>
                    </div>

                    <div className="flex flex-col min-[500px]:flex-row items-start min-[500px]:items-center gap-4 min-[500px]:justify-between w-full">
                        <div className="flex items-center gap-3">
                            <img src="https://res.cloudinary.com/daup99ghe/image/upload/v1776790906/Lab_Tested_lntale.png" alt="lab" className="w-7 h-7 object-contain" />
                            <span className="text-[15px] font-[400] text-[#303030]">Lab Tested</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <img src="https://res.cloudinary.com/daup99ghe/image/upload/v1776790906/Expert_Verified_mgwfw3.png" alt="expert" className="w-7 h-7 object-contain" />
                            <span className="text-[15px] font-[400] text-[#303030]">Expert Verified</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <img src="https://res.cloudinary.com/daup99ghe/image/upload/v1776790906/Gia_Certified_uh1ebk.png" alt="gia" className="w-7 h-7 object-contain" />
                            <span className="text-[15px] font-[400] text-[#303030]">Gia Certified</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-12">
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-1 min-[500px]:grid-cols-2 gap-8 min-[500px]:gap-20">
                                    <div className="flex flex-col gap-8">
                                        <h4 className="text-[20px] font-medium text-[#E57661]">Physical Attributes</h4>
                                        <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-col gap-8">
                                        <h4 className="text-[20px] font-medium text-[#E57661]">Vedic Details</h4>
                                        <div className="flex flex-col gap-6">
                                            <div className="flex justify-between text-[15px]">
                                                <span className="text-[#303030] font-medium">Day:</span>
                                                <span className="text-[#303030] font-medium">{product.vedicDetails?.day || 'TBD'}</span>
                                            </div>
                                            <div className="flex justify-between text-[15px]">
                                                <span className="text-[#303030] font-medium">Finger:</span>
                                                <span className="text-[#303030] font-medium">{product.vedicDetails?.finger || 'TBD'}</span>
                                            </div>
                                            <div className="flex justify-between text-[15px]">
                                                <span className="text-[#303030] font-medium">Metal:</span>
                                                <span className="text-[#303030] font-medium">{product.vedicDetails?.metal || 'TBD'}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="flex flex-col">
                        <div className="bg-[#E57661] rounded-[22px] p-5 min-[500px]:p-8 text-white relative overflow-hidden">
                            <h3 className="text-[23px] font-bold mb-3">{product.wearingRitual?.title || 'Wearing Ritual'}</h3>
