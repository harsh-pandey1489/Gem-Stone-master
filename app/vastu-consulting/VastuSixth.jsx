...
export default function VastuSixth() {
    return (
        <section className="bg-[radial-gradient(140.3%_104.29%_at_10%_20%,rgba(254,212,136,0.15)_0%,#F8F9FA_90%)] py-10 px-4 md:px-10 lg:px-20">
            <div className="max-w-[1250px] mx-auto flex flex-col gap-6">
               <div>
                ...
                <div className="grid lg:grid-cols-[57%_43%] justify-center items-center gap-2">
                    ...
                    {/* BIG CARD */}
                    <div className="bg-[#FFFFFF] p-4 md:p-6 rounded-3xl">
                ...
                <div className="grid lg:grid-cols-[40%_60%] gap-2">
                    ...
                    {/* LEFT CARD */}
                    <div className="bg-[#775A19] text-white p-12 rounded-3xl flex flex-col justify-between">
                        <div>
                            <Image
                                src={data.plot.icon}
                                alt="icon"
